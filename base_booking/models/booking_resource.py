...
class BookingResource(models.Model):
    ...
    resource_calendar_id = fields.Many2one(
        default=lambda self: (
            self.env.ref('base_booking.booking_default_resource_calendar', raise_if_not_found=False) or
    ...
    source_resource_ids = fields.Many2many(
        'booking.resource', 'booking_resource_linked_booking_resource',
    ...
    booking_type_ids = fields.Many2many('booking.type', string="Available in",
    ...
    def _get_filtered_possible_capacity_combinations(self, asked_capacity, capacity_info):
        ...
        :param int asked_capacity: asked capacity for the booking
    ...
    def _prepare_resource_values(self, vals, tz):
        ...
        the resources created for our booking.resources """
