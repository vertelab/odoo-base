# -*- coding: utf-8 -*-
"""res.partner — OKF-indexerbar (base_ai).

Modellen äger sina KÄLLOR; `ai.okf.mixin` äger fälten och flaggan.

VARFÖR res.partner BÄR MIXINEN: den är en av de mest länkade modellerna i
...
class ResPartner(models.Model):
    ...
    def _okf_dirty_fields(self):
        ...
        """
        return {'name', 'email', 'phone', 'mobile', 'website', 'comment', 'function', 'title', 'street', 'city', 'zip', 'vat', 'active'}
    ...
    def _register_hook(self):
        ...
        self.env['ai.okf.mixin']._okf_register_indexable('res.partner')
        return res
