...
class IrModelFields(models.Model):
    ...
    map_id = fields.One2many(comodel_name='ir.model.fields.mapping', inverse_name='odoo_field', string='Mapped line id',
                             copy=False)
    map_system = fields.Char(string='Mapped system', related='map_id.target_system',
                             help="The name of the mapped system")
    map_table = fields.Char(string='Mapped system table', related='map_id.target_table',
                            help="The name of the table in the mapped system")
    map_field = fields.Char(string='Mapped system field', related='map_id.target_field',
                            help="The name of the field in the mapped system")
    map_odoo_master = fields.Boolean(string='Odoo master', related='map_id.odoo_master',
                                     help="Is Odoo master of the data?")
    map_type = fields.Char(string='Mapped type', related='map_id.target_type',
...
class IrModelFieldsMapping(models.Model):
    ...
    odoo_field = fields.Many2one(comodel_name='ir.model.fields', string='Odoo Field', help="The mapped Odoo field",
                                 copy=False)
