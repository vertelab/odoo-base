...
class CalendarTaskType(models.Model):
    ...
    right_type = fields.Selection(string='Right Type',
                                  selection=[('', 'N/A'), ('STARK', 'Stark'), ('MYCKET_STARK', 'Mycket Stark')])
    reason_code = fields.Char(string='Reason Code', size=3, trim=True, )
    reason = fields.Char(string='Reason', size=25, trim=True, )
    interval = fields.Selection(
        selection=[('1', '1 day'), ('7', '1 week'), ('14', '2 weeks'), ('30', '30 days'), ('60', '60 days'),
                   ('100', '100 days'), ('365', 'a Year')], string='Interval', default='1')
    client_responsible = fields.Boolean(string='Client Responsible',
