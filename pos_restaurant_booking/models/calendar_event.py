...
class CalendarEvent(models.Model):
    ...
    def _load_pos_data_domain(self, data):
        ...
        booking_type_id = [config['booking_type_id'] for config in data['pos.config']['data']]
        return [
            ('booking_line_ids.booking_resource_id', 'in', [table['booking_resource_id'] for table in data['restaurant.table']['data']]),
            ('booking_type_id', 'in', booking_type_id),
    ...
    def _fields_for_restaurant_table(self):
        return ['id', 'start', 'duration', 'stop', 'name', 'booking_type_id', 'booking_status', 'booking_resource_ids', 'resource_total_capacity_reserved']
    ...
    def _send_table_notifications(self, events, command):
        ...
        for event in events:
            ...
            event_table_ids = event.booking_line_ids.booking_resource_id.sudo().pos_table_ids
