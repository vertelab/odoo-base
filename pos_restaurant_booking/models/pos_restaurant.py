...
class RestaurantTable(models.Model):
    ...
    def create(self, vals_list):
        ...
        for table in tables:
            if not table.booking_resource_id:
                table.booking_resource_id = table.env['booking.resource'].sudo().create({
    ...
    def unlink(self):
        for table in self:
            table.booking_resource_id.sudo().unlink()
    ...
    def _delete_linked_resources(self):
        for table in self:
            table.booking_resource_id.unlink()
